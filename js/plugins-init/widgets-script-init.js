		...
		var chartWidget9 = function () {
			...
			if (jQuery('#chart_widget_9').length > 0) {
				...
				new Chart(chart_widget_9, {
					type: "line",
					data: {
						labels: ["Janeiro", "Fevereiro", "Março", "Abril", "Maio", "Junho", "Julho, "Agosto", "Setembro", "Outubro", "Janeiro", "Fevereiro", "Março", "Abril", "Maio", "Junho", "Julho, "Agosto", "Setembro", "Outubro", "Janeiro", "Fevereiro", "Março", "Abril", "Maio", "Junho", "Julho, "Agosto", "Setembro", "Outubro", "Janeiro", "Fevereiro", "March", "April"],
						datasets: [{
								label: "Sales Stats",
								backgroundColor: "#25dc8c",
								borderColor: '#25dc8c',
								pointBackgroundColor: '#25dc8c',
								pointBorderColor: '#25dc8c',
								pointHoverBackgroundColor: '#25dc8c',
								pointHoverBorderColor: '#25dc8c',
