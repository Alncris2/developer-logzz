                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-4 order-md-1 mb-4" style="background: #c8ffe6;padding: 20px 10px;border-radius: 10px;">
                                ...
                                <ul class="list-group mb-3">
                                    ...
                                    <?php if($sale_freight != null) { ?>
                                        <li class="list-group-item d-flex justify-content-between lh-condensed">
                                            <div>
                                                <h6 class="my-0">Frete</h6>
                                                <small class="text-muted"></small>
                                            </div>
                                            <span class="text-muted">R$ <?php echo number_format($sale_freight, 2, ',', '')?></span>
                                        </li>
                                    <?php } ?>
                                    ...
                                    <li class="list-group-item d-flex justify-content-between">
                                        ...
                                        <strong id="show-final-price">R$ <?php if($sale_freight != null) { echo number_format($sale_price + $sale_freight, 2, ',', '.'); } else { echo number_format($sale_price, 2, ',', '.'); } ?></strong>
                                     </li>
                                </ul>
