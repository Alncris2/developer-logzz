                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="cashedout">Filtro por data personalizado</h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Fechar">
                                                    <span aria-hidden="true"></span>
                                                </button>
                                            </div>
                                            <div class="modal-body">                                                     
                                                ...
                                                <button type="button" class="btn btn-sm btn-success mt-1 close" onclick="get_historic_balance()" data-dismiss="modal" >Filtrar</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="card accordion__item">
            ...
            <div id="future-releases-collapse" class="card-bodyaccordion__body" data-parent="#finances-accordion">
                <div class="accordion__body--text">
                    ...
                    <div id="future-releases-accordion" class="accordion accordion-with-icon col-md-12"></div>
...
<script>
    ...
    $('#export-to-xlsx').on('click', function() {
        dados = new FormData();
        $(".filter-option-days-historic").each(function(index, value) {
            if ($(this).hasClass('active')) {
                dados.append('tipo_date', $(this).data('filter'));
        ...
        let url = u + "/ajax/export-historic-transaction.php";
        ...
        .then(response => {
            ...
            a.href = downloadUrl;
            a.download = "Historico de transações - logzz.xls";
