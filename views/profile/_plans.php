        ...
        <div class="col-xl-3 col-lg-4 col-sm-4">
            <div class="card overflow-hidden">
                <div class="card-body">
                    ...
                    <small><p class="text-muted text-center mb-2 mt-4"><strong>4.97%</strong> de taxa p/ pagamento físico</p></small>
                    ...
                    <small><p class="text-muted text-center mb-2"><strong>R$ 26,90</strong> por entrega em todo o BR (incluso manuseio, sendo esse R$0,00)</p></small>
        ...
        <div class="col-xl-3 col-lg-4 col-sm-4">
            <div class="card overflow-hidden">
                <div class="card-body">
                    ...
                    <small><p class="text-muted text-center mb-2 mt-4"><strong>3.97%</strong> de taxa p/ pagamento físico</p></small>
                    ...
                    <small><p class="text-muted text-center mb-2"><strong>R$ 25,90</strong> por entrega em todo o BR (incluso manuseio, sendo esse R$0,00)</p></small>
