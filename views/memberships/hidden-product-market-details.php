...
if (isset($_GET['detalhe'])) {
    $product_code = addslashes($_GET['detalhe']);
    $user__id = $_SESSION['UserID'];

    $stmt = $conn->prepare('SELECT * FROM products WHERE (product_code = :product_code AND product_trash = 0) AND product_membership_available = :product_membership_available');
    $stmt->execute(array('product_code' => $product_code, 'product_membership_available' => 'sim'));
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-9 col-lg-6  col-md-6 col-xxl-7 col-sm-12">
                                <div class="product-detail-content">
                                    <div class="alert alert-success fade show mb-3" style="width: fit-content;">
                                        <i class="fa fa-info-circle" aria-hidden="true"></i><strong> Você foi convidado para se afiliar a este produto.
                                    </div>
                                    <!--Product details-->
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td class="text-center"><?php echo number_format($sale_price, 2, ',', '');  ?></td>
                                                <td class="text-center">R$ <?php echo number_format(($sale_price * ($product_commission / 100)), 2, ',', ''); ?></td>
                                            </tr>
                                        <?php
                                        }
                                    } else {
