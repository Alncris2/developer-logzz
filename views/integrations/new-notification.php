                        ...
                        <div class="col-lg-12 col-md-12 order-md-2">
                            <form id="ReportShipForm" action="<?php echo SERVER_URI; ?>">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label class="text-label">Programar Disparo:</label>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" id="customRadioInline1" name="customRadioInline" class="custom-control-input">
                                            <label class="custom-control-label" for="customRadioInline1">Imediato</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" id="customRadioInline2" name="customRadioInline" class="custom-control-input">
                                            <label class="custom-control-label" for="customRadioInline2">Programado</label>
                                        </div>
                                    </div>
                                    ...
                                    <button class="btn btn-success btn-lg btn-block" type="submit" name="action">Salvar</button>
