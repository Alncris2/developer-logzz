...
$page_title = "Integração Braip | Logzz";
    ...
    <div class="col-xl-12 col-xxl-12">
      <div class="card">
        <div class="card-header">
           <h4 class="card-title">Integração com a Braip 
               <a href="<?php echo SERVER_URI; ?>/ajuda/integracao-braip/" target="_blank">
        ...
        <div class="card-body">
        <?php if(!isset($_GET['e'])): ?>
            <form id="IntegrationBraip" action="<?= SERVER_URI . "/integracoes/ajax/postback/braip/"?>" method="POST">
                    <div class="row">
                      <div class="col-lg-12 mb-2">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" name="integration-unique-key" class="form-control" required data-toggle="tooltip" data-placement="left" title="Cole a Chave Única da sua conta da Braip">
                          </div>
                          <div class="form-group">
                            <label class="text-label">Token da sua conta braip<i class="req-mark">*</i></label>
                            <input type="text" name="integration-token-key" class="form-control" required data-toggle="tooltip" data-placement="left" title="Cole o token da api da conta Braip">
                          </div>
                          <div class="form-group">
                              <label class="text-label">Produto<i class="req-mark">*</i></label>
                              <select id="select-integration-product" name="integration-product-id" class="d-block default-select" data-toggle="tooltip" data-placement="left" title="Cole a Chave Única da sua conta da Braip">
