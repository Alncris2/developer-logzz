...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-xl-12 col-xxl-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Bling - Região Norte</h4>
                </div>
                <div class="card-body">
                    <form id="IntegrationBling" action="bling-norte" method="POST">
                        <div class="row">
                            <div class="col-lg-12 mb-2">
                                <input type="hidden" name="action" value="new-integration-bling-norte">
        ...
        <div class="col-xl-12 col-xxl-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Integrações Ativas - Região Norte</h4>
                </div>
                <div class="card-body">
                        <div class="row">
                            ...
                            <?php
                                ...
                                $get_dispatche_list = $conn->prepare('SELECT dispatche_name, dispatche_ufs, dispatche_users FROM bling_dispatches WHERE dispatche_region_id = 2 ORDER BY dispatche_id DESC');
