...
// PEGAR PRODUTOS DE UM USUÁRIO EXPECIFICO
...
$get_dispatche_list = $conn->prepare('SELECT * FROM tiny_dispatches WHERE dispatche_region_id = 4 ORDER BY id DESC');
        ...
        <div class="col-xl-12 col-xxl-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Tiny - Centro Oeste</h4>
                </div>
                <div class="card-body">
                    <form id="IntegrationTiny" action="/api/v1/integrationTiny" method="POST">
                        <div class="row">
                            <div class="col-lg-12 mb-2">
                                <input type="hidden" name="action" value="new-integration-tiny-oeste">
                                            ...
                                            <select id="" class="tiny-product-list" name="tiny-products-list" multiple="multiple" required>
                                                <?php if ($get_products_list->rowCount() != 0): ?>
                                                    <?php  while($row = $get_products_list->fetch()): ?>
                                                        ...
                                                        ?>
                                                        <option value="<?= $user__id  ?>"><?= $full_name . " <small>[" . $user_code . "]</small>"  ?></option>
                                                    <?php endwhile; ?>
                                                <?php endif; ?>
                                            </select>
