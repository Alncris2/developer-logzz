...
if (!(isset($_GET['a'])) || !(isset($_GET['s']))){
    ...
    $get_sale_data = $conn->prepare('SELECT sale_name, sale_quantity, sale_price, sale_status, product_id, sale_url, sale_freight, type_checkout FROM sales WHERE sale_id = :sale_id');
    ...
    # Busca os dados de Pixel, Analytcs, etc, se existentes
    ...
    $product_data = $conn->prepare('SELECT product_name, user__id, product_code, product_price, product_description, product_image, product_id, product_cookie_time, product_membership_type FROM products WHERE product_id = :product_id');
	...
	$update_views->execute(['checkout_name' => $checkout_id, 'user__id' => $user_id]);
	...
	$get_checkout->execute(['user__id' => $user_id, 'name_checkout' => $checkout_id]);
...
// 				->setEventTime(time())
// 				->setEventSourceUrl(SERVER_URI.'/checkout/MinoxidilComFatorDeCrescimento')
...
// }
	...
	// if(isset($fb_pixel) && !(empty($fb_pixel))){
	// 	$fb_pixel_code = "<script>
	...
	if(isset($tiktok_pixel) && !(empty($tiktok_pixel))){
		...
		$tiktok_pixel_code = '<script>altert("google_aw");</script>';
	}
    ...
    <div class="timer-container container-fluid d-flex justify-content-center" style="background:<?=$checkout['checkout_bg_counter']?>;height:65px;width:100%;">
        <div class="text-center d-flex justify-content-center align-items-center" >
            ...
            <div class="mr-2 d-flex justify-content-center align-items-center">
                ...
                <svg style="width:16px;" fill="<?= $checkout['checkout_text_counter']?>" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="<?= $checkout['checkout_text_counter']?>"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M256 512C114.6 512 0 397.4 0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256C512 397.4 397.4 512 256 512zM232 256C232 264 236 271.5 242.7 275.1L338.7 339.1C349.7 347.3 364.6 344.3 371.1 333.3C379.3 322.3 376.3 307.4 365.3 300L280 243.2V120C280 106.7 269.3 96 255.1 96C242.7 96 231.1 106.7 231.1 120L232 256z"/></svg> 
            </div>
        </div> 
    </div> 
<?php endif; ?>
...
<div class="row" style="width:100%;margin: 0 auto; <?= $checkout['counter_active'] == 1 ? 'margin-top: -48px;' : '' ?> ">  
    <div class="main-container <?= $urlImage ? 'col-lg-8' : 'col-lg-12'; ?> col-md-12"> 
        <div class="col-lg-8 mt-5" style="max-width: 1000px; <?= $urlImage ? 'margin-left: auto;' : 'margin: 0 auto;'; ?>">
			...
			<div class="card">
				...
				<div class="card-body">
                    <form id="mbsCheckoutForm" action="<?php echo CHECKOUT_URI; ?>">
                        <input type="hidden" name="hotcode" value="<?= $membership_hotcode ?>">
                        <div class="row">
                            <div class="col-lg-4 col-md-4 order-md-1 mb-4 d-sm-none d-lg-block d-none" style="background: <?= $checkout['checkout_box_color'] !== "" ? $checkout['checkout_box_color'] : '#c8ffe6'?>;padding: 20px 10px;border-radius: 10px;">
                                ...
                                <ul class="list-group mb-3 d-sm-none d-lg-block d-none">
                                    ...
                                    <li class="list-group-item d-flex justify-content-between">
                                        ...
                                        <strong id="show-final-price" style="color:<?= $checkout['checkout_box_text_color']; ?>!important;">R$ <?php echo number_format($sale_price + $sale_freight, 2,',', '.'); ?></strong>
                                    </li>
                                            ...
                                            <div class="d-flex align-items-center justify-content-center">                                                
                                                <?php if($checkout['support_email'] !== ""): ?>                                                
                                                    <a href="mailto:<?=$checkout['support_email']?>" id="email-link" title="Email">
                                                        <svg style="width:25px;margin-right:20px;" xmlns="http://www.w3.org/2000/svg" fill="<?= $checkout['checkout_box_text_color']; ?>" viewBox="0 0 512 512"><path d="M464 64C490.5 64 512 85.49 512 112C512 127.1 504.9 141.3 492.8 150.4L275.2 313.6C263.8 322.1 248.2 322.1 236.8 313.6L19.2 150.4C7.113 141.3 0 127.1 0 112C0 85.49 21.49 64 48 64H464zM217.6 339.2C240.4 356.3 271.6 356.3 294.4 339.2L512 176V384C512 419.3 483.3 448 448 448H64C28.65 448 0 419.3 0 384V176L217.6 339.2z"/></svg>
                                                    </a>
                                                <?php endif; ?>
                                                <?php if($checkout['support_whatsapp'] !== ""): ?>          
                                                    <a id="whatsapp-link" href="https://api.whatsapp.com/send?phone=55<?= str_replace([" ", "-", "(", ")"], "", $checkout['support_whatsapp'])?>" title="WhastApp">
                                                        <svg style="width:25px;"  xmlns="http://www.w3.org/2000/svg" fill="<?= $checkout['checkout_box_text_color']; ?>" viewBox="0 0 448 512"><path d="M380.9 97.1C339 55.1 283.2 32 223.9 32c-122.4 0-222 99.6-222 222 0 39.1 10.2 77.3 29.6 111L0 480l117.7-30.9c32.4 17.7 68.9 27 106.1 27h.1c122.3 0 224.1-99.6 224.1-222 0-59.3-25.2-115-67.1-157zm-157 341.6c-33.2 0-65.7-8.9-94-25.7l-6.7-4-69.8 18.3L72 359.2l-4.4-7c-18.5-29.4-28.2-63.3-28.2-98.2 0-101.7 82.8-184.5 184.6-184.5 49.3 0 95.6 19.2 130.4 54.1 34.8 34.9 56.2 81.2 56.1 130.5 0 101.8-84.9 184.6-186.6 184.6zm101.2-138.2c-5.5-2.8-32.8-16.2-37.9-18-5.1-1.9-8.8-2.8-12.5 2.8-3.7 5.6-14.3 18-17.6 21.8-3.2 3.7-6.5 4.2-12 1.4-32.6-16.3-54-29.1-75.5-66-5.7-9.8 5.7-9.1 16.3-30.3 1.8-3.7.9-6.9-.5-9.7-1.4-2.8-12.5-30.1-17.1-41.2-4.5-10.8-9.1-9.3-12.5-9.5-3.2-.2-6.9-.2-10.6-.2-3.7 0-9.7 1.4-14.8 6.9-5.1 5.6-19.4 19-19.4 46.3 0 27.3 19.9 53.7 22.6 57.4 2.8 3.7 39.1 59.7 94.8 83.8 35.2 15.2 49 16.5 66.6 13.9 10.7-1.6 32.8-13.4 37.4-26.4 4.6-13 4.6-24.1 3.2-26.4-1.3-2.5-5-3.9-10.5-6.6z"/></svg>
                                                    </a>      
                                                <?php endif; ?>
                                            </div>   
                                        </li>  
                                ...
                                <div class="row">
                                    <div class="form-gruop col-md-12">
                                        ...
                                        <div class="w-100 mb-3"  id="data-pedido-wrapper">
                                            <input name="data-pedido" value="Data" class="datepicker-checkout form-control picker__input" id="data-pedido" readonly="" aria-haspopup="true" aria-expanded="false" aria-readonly="false" aria-owns="datepicker_root" placeholder="dia / mês / ano">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4 col-md-12 col-md-4 my-4 d-lg-none d-sm-block d-md-block" style="background: <?= $checkout['checkout_box_color'] !== "" ? $checkout['checkout_box_color'] : '#c8ffe6'?>;padding: 20px 10px;border-radius: 10px;">
                                        <ul class="list-group mb-3">
                                            ...
                                            <li class="list-group-item d-flex justify-content-between">
                                                ...
                                                <strong id="show-final-price"  style="color:<?= $checkout['checkout_box_text_color']; ?>!important;">R$ <?php if($sale_freight != null) { echo number_format($sale_price + $sale_freight, 2, ',', '.'); } else { echo number_format($sale_price, 2, ',', '.'); } ?></strong>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <?php if($checkout['support_active'] == 1): ?>
                                        <li class="d-flex justify-content-center flex-column" style="margin-top: 10px;">
                                            ...
                                            <div class="d-flex align-items-center justify-content-center">                                                
                                                <?php if($checkout['support_email'] !== ""): ?>                                                
                                                    <a href="mailto:<?=$checkout['support_email']?>" id="email-link" title="Email">
                                                        <svg style="width:25px;margin-right:20px;" xmlns="http://www.w3.org/2000/svg" fill="#1c3c2d" viewBox="0 0 512 512"><path d="M464 64C490.5 64 512 85.49 512 112C512 127.1 504.9 141.3 492.8 150.4L275.2 313.6C263.8 322.1 248.2 322.1 236.8 313.6L19.2 150.4C7.113 141.3 0 127.1 0 112C0 85.49 21.49 64 48 64H464zM217.6 339.2C240.4 356.3 271.6 356.3 294.4 339.2L512 176V384C512 419.3 483.3 448 448 448H64C28.65 448 0 419.3 0 384V176L217.6 339.2z"/></svg>
                                                    </a>
                                                <?php endif; ?>
                                                <?php if($checkout['support_whatsapp'] !== ""): ?>          
                                                    <a id="whatsapp-link" href="https://api.whatsapp.com/send?phone=55<?= str_replace([" ", "-", "(", ")"], "", $checkout['support_whatsapp'])?>" title="WhastApp">
                                                        <svg style="width:25px;"  xmlns="http://www.w3.org/2000/svg" fill="#1c3c2d" viewBox="0 0 448 512"><path d="M380.9 97.1C339 55.1 283.2 32 223.9 32c-122.4 0-222 99.6-222 222 0 39.1 10.2 77.3 29.6 111L0 480l117.7-30.9c32.4 17.7 68.9 27 106.1 27h.1c122.3 0 224.1-99.6 224.1-222 0-59.3-25.2-115-67.1-157zm-157 341.6c-33.2 0-65.7-8.9-94-25.7l-6.7-4-69.8 18.3L72 359.2l-4.4-7c-18.5-29.4-28.2-63.3-28.2-98.2 0-101.7 82.8-184.5 184.6-184.5 49.3 0 95.6 19.2 130.4 54.1 34.8 34.9 56.2 81.2 56.1 130.5 0 101.8-84.9 184.6-186.6 184.6zm101.2-138.2c-5.5-2.8-32.8-16.2-37.9-18-5.1-1.9-8.8-2.8-12.5 2.8-3.7 5.6-14.3 18-17.6 21.8-3.2 3.7-6.5 4.2-12 1.4-32.6-16.3-54-29.1-75.5-66-5.7-9.8 5.7-9.1 16.3-30.3 1.8-3.7.9-6.9-.5-9.7-1.4-2.8-12.5-30.1-17.1-41.2-4.5-10.8-9.1-9.3-12.5-9.5-3.2-.2-6.9-.2-10.6-.2-3.7 0-9.7 1.4-14.8 6.9-5.1 5.6-19.4 19-19.4 46.3 0 27.3 19.9 53.7 22.6 57.4 2.8 3.7 39.1 59.7 94.8 83.8 35.2 15.2 49 16.5 66.6 13.9 10.7-1.6 32.8-13.4 37.4-26.4 4.6-13 4.6-24.1 3.2-26.4-1.3-2.5-5-3.9-10.5-6.6z"/></svg>
                                                    </a>      
                                                <?php endif; ?>
                                            </div>
                                        </li>
