...
$first_access_mail_body = '<table align="center" border="0" cellpadding="0" cellspacing="0" height="100%"
                                                            ...
                                                            <tr>
                                                                <td valign="top"
                                                                    ...
                                                                    <img align="center" alt=""
                                                                        src="https://dashboard.dropexpress.com.br/images/logo-full.png"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td valign="top"
                                                                    ...
                                                                    <h1
                                                                        ...
                                                                        <span style="color:#51585f">Seja Bem-vindo ao
                                                                            DropExpress!</span>
                                                                    </h1>
                                                                            ...
                                                                            <tr>
                                                                                <td valign="top"
                                                                                    ...
                                                                                    <div style="padding:35px 60px">
                                                                                        ...
                                                                                        <br>
                                                                                        <br>A sua conta está pronta! \o/
                                                                                        <br><br>
                                                                                        Estes são os seus dados de acesso:
                                                                                        <br><br>
                                                                                        <strong>Email: </strong> ' . @$user_email . '<br>
                                                                                        <strong>Senha: </strong> ' . @$user_pass . '<br>
                                                                                        <br>
                                                                                        <br>
                                                                                        <a href="https://dashboard.dropexpress.com.br/?email=' .@$user_email . '"
                                                                                            ...
                                                                                            title="Acesse agora"
                                                                                            target="_blank"
                                                                                            data-saferedirecturl="https://www.google.com/url?q=https://dashboard.dropexpress.com.br/?email=' . @$user_email . '">Acessar o Dashboard</a>
                                                                                            <br><br>
                                                                                        <br>
