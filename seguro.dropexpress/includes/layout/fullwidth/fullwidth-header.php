...
<head>
    ...
    <meta name="title" content="<?php if(isset($page_title)) {echo $page_title;} else {echo 'Logzz | Dashboard';}?>">
    <!-- <meta name="description" content="<?php if(isset($page_description)) {echo $page_description;} else {echo 'Logzz';}?>"/> -->

    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://dashboard.Logzz.com.br/">
    <meta property="og:title" content="<?php if(isset($page_title)) {echo $page_title;} else {echo 'Logzz | Dashboard';}?>">
    <!-- <meta property="og:description" content="<?php if(isset($page_description)) {echo $page_description;} else {echo 'Logzz';}?>"> -->
    <!-- <meta property="og:image" content="https://app.Logzz.com.br/images/meta-og-image-dashboard-drop-express.jpg"> -->

    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="https://dashboard.Logzz.com.br/">
    <meta property="twitter:title" content="<?php if(isset($page_title)) {echo $page_title;} else {echo 'Logzz | Dashboard';}?>">
    <!-- <meta property="twitter:description" content="<?php if(isset($page_description)) {echo $page_description;} else {echo 'Logzz';}?>"> -->
    <!-- <meta property="twitter:image" content="https://app.Logzz.com.br/images/meta-og-image-dashboard-drop-express.jpg"> -->
    ...
    if(isset($google_ua_code)){
        echo $google_ua_code;
    }
    
    if(isset($google_aw_code)){
        echo $google_aw_code;
    }

    if(isset($tiktok_pixel_code)){
        echo $tiktok_pixel_code;
    }
