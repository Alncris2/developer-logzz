...
$integration_api_token = $_POST['integration-token-key'];
...
if ($get_product_name->rowCount() != 0) {
  ...
  $integration_product_name = $integration_product_name['product_name'];
	...
	$url = SERVER_URI . "/postback/braip/" . $unique_string; 
...
if ($_POST['action'] == 'new-integration-braip'){
