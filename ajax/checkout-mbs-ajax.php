...
if($_POST['action'] == "done-order") {
    ...
    $email 					= isset($_POST['email-pedido']) ? addslashes($_POST['email-pedido']) : ' ';
    ...
    $verify_custom_commision = $conn->prepare('SELECT meta_value FROM sales_meta WHERE sale_id = :sale_id AND meta_key = :meta_key');
