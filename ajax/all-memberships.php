...
$page_title = "Minhas Afiliações | DropExpress";
...
<div class="container-fluid">
    <div class="row">
        ...
        $get_active_memberships = $conn->prepare("SELECT * FROM products_memberships as M INNER JOIN products as P ON m.membership_product_id = p.product_id WHERE membership_affiliate_id = :membership_affiliate_id AND membership_status = 'ATIVA'");
